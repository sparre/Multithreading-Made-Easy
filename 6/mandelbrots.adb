...
package body Mandelbrots is
   ...
   package Queues is new Ada.Containers.Bounded_Synchronized_Queues
     (Queue_Interfaces => Queue_Interfaces,
      Default_Capacity => 10);


   procedure Compute_G (Set              : in Set_T;
                        Rectangle        : in XCB.Rectangle.T;
      ...
      task type Rectangle_Worker;

      Q : Queues.Queue;
      All_Enqueued : Boolean := False;
      ...
      Workers : array (1 .. 4) of Rectangle_Worker with Unreferenced;

      use type Interfaces.Unsigned_16;
      use type Interfaces.Integer_16;
      Sub_Rectangles_Width : constant Interfaces.Unsigned_16
        := Rectangle.Width / Sub_Rectangles_X;
      Sub_Rectangles_Height : constant Interfaces.Unsigned_16
        := Rectangle.Height / Sub_Rectangles_Y;
   begin -- Compute_G
